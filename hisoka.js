            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                        urlButton: {
                            displayText: 'Website',
                            url: 'https://erdwpe.com'
                        }
                    }, {
                        callButton: {
                            displayText: 'Number Phone Owner',
                            phoneNumber: '+62 813-9264-1570'
                        }
                    }]
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
	        ...
	        case 'tiktok': case 'tiktoknowm': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(`https://erdwpe-api.herokuapp.com/downloader/tiktok?url=${text}`)
                let buttons = [
	        ...
	        case 'twitdl': case 'twitter': {
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(`https://erdwpe-api.herokuapp.com/downloader/twitter?link=${text}`)
